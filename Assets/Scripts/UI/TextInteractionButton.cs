...
public class TextInteractionButton : MonoBehaviour
{
    ...
    private void Start() => PlayerInputHandler.Instance.OnDialogueInteractionPressed += PlayerInputHandler_OnDialogueInteractionPressed;
    private void OnDestroy() => PlayerInputHandler.Instance.OnDialogueInteractionPressed -= PlayerInputHandler_OnDialogueInteractionPressed;
