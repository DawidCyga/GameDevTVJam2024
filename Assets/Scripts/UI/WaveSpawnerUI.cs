...
public class WaveSpawnerUI : MonoBehaviour
{
    ...
    private void Awake() => UpdateUIVisibility(false);
    ...
    private void WaveSpawner_OnWaveCleared(object sender, WaveSpawner.OnWaveClearedEventArgs e) => UpdateUIVisibility(false);
